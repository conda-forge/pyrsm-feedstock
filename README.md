...
Once the `conda-forge` channel has been enabled, `pyrsm` can be installed with:

```
conda install pyrsm
```

It is possible to list all of the versions of `pyrsm` available on your platform with:
